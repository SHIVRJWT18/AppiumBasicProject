...
public class BasePage {
    ...
    {
	 Aryl = new ArrayList (adriver.getWindowHandles());
		
	 System.out.println(Aryl.size());
		
	 adriver.switchTo().window((String) Aryl.get(Aryl.size()-1));
	...
	public void SwitchWindowToBackward() throws InterruptedException 
	{
   	 ...
   	 adriver.switchTo().window((String) Aryl.get(Aryl.size()-2));
	}
